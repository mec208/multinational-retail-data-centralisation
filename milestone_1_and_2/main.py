...
my_connector = database_connector.DatabaseConnector()
my_extractor = data_extractor.DataExtractor()
my_cleaner = data_cleaning.DataCleaning()
...
# Number of stores
endpoint = (
    "https://aqj7u5id95.execute-api.eu-west-1"
    ".amazonaws.com/prod/number_stores"
)
headers = {
...
number_of_stores = my_extractor.list_number_of_stores(
    endpoint, 
    headers
)
...
endpoint = (
    "https://aqj7u5id95.execute-api.eu-west-1"
    ".amazonaws.com/prod/store_details/"
)
headers = {
    "Content-Type": "application/json",
    "x-api-key": "yFBQbwXe9J3sd6zWVAMrK6lcxxr0q1lr2PT6DDMX"
...
stores_df = my_extractor.retrieve_stores_data(
    endpoint, 
    headers, 
    number_of_stores
)
...
products_df = my_cleaner.clean_product_data(products_df)
products_df.info()
...
inspector = database_connector.inspect(db_engine)
...
orders_df = my_extractor.read_rds_table(
    my_connector, 
    "orders_table"
)
orders_df.info()
...
orders_df = my_cleaner.clean_order_data(orders_df)
orders_df.info()
